...
**[Latest release](https://github.com/Qinaii/qtracker-spaceaces/releases/latest)** · Windows 10/11 · `qtracker_v0.0.4-alpha.exe`

Tesseract OCR is bundled. No separate install needed for the release build.

## Quick start

1. Download and run `qtracker_v0.0.4-alpha.exe` from Releases
2. Open **Settings**
...
| Area | What you get |
|------|----------------|
| **Dashboard** | Live values, session deltas, Uri/h, farming goal with ETA |
...
| **Session** | Start sets baseline, Pause pauses tracking, Reset Hud clears session counters |
...
| Spike in Uridium | qTracker filters suspicious jumps; check debug snapshots |
